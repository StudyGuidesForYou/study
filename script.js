...
function initChat(supabase) {
    ...
    startButton.onclick = () => {
        ...
        if (!name) { nameMsg.textContent = "Please enter a display name!"; return; }
        currentUser = name;
    ...
    // Auto-load saved display name
    const saved = localStorage.getItem('chatUser');
    if (saved) { currentUser = saved; startChat(); }
